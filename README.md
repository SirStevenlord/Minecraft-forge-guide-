...
Download the files from #necessary📖 
...
Now that you in the Minecraft folder location on windows, Look for an folder named mods if you see them drop the files you downloaded from #necessary📖 into it and if you don't see a folder named mods just make a folder named "mod" then do the same step 
